...
save_path = 'C:/Users/franc/PycharmProjects/TFC/checkpoints/rnn_test_run'
scaler_path = 'C:/Users/franc/PycharmProjects/TFC/checkpoints/rnn_scaler.pkl'
...
y_pred = Y_hat_df['RNN-median'].to_numpy().reshape(-1, 1)
...
output_df.to_csv(f'{results_dir}/rnn_dez2020_predictions.csv', index=False)
...
pd.DataFrame([metrics]).to_csv(f'{results_dir}/metrics_rnn.csv', index=False)


ax.set_title('Previsão com RNN e Dados Reais', fontsize=22)
