...
# Caminhos
scaler_path = 'C:/Users/franc/PycharmProjects/TFC_1/checkpoints/kan_scaler.pkl'
file_path = 'BTC_2018_2024.csv'
results_dir = 'C:/Users/franc/PycharmProjects/TFC_1/checkpoints/kan_test_run'
...
# Modelos a comparar
modelos = {
    'Default': 'C:/Users/franc/PycharmProjects/TFC_1/checkpoints/kan_test_run/default',
    'Modificado': 'C:/Users/franc/PycharmProjects/TFC_1/checkpoints/kan_test_run/moded'
}
...
for nome, path in modelos.items():
    ...
    y_pred = Y_hat_df['KAN-median'].to_numpy().reshape(-1, 1)
...
ax.set_title('Comparação de Previsões KAN', fontsize=22)
