...
save_path = 'C:/Users/franc/PycharmProjects/TFC/checkpoints/kan_test_run'
scaler_path = 'C:/Users/franc/PycharmProjects/TFC/checkpoints/kan_scaler.pkl'
...
output_df.to_csv(f'{results_dir}/kan_dez2020_predictions.csv', index=False)
...
pd.DataFrame([metrics]).to_csv(f'{results_dir}/metrics_kan.csv', index=False)


ax.set_title('Previsão com KAN e Dados Reais', fontsize=22)
