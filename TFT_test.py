...
save_path = 'C:/Users/franc/PycharmProjects/TFC/checkpoints/tft_test_run'
scaler_path = 'C:/Users/franc/PycharmProjects/TFC/checkpoints/tft_scaler.pkl'
file_path = 'BitcoinPrice.csv'

# Carregar dados reais
full_df = pd.read_csv(file_path)
full_df.rename(columns={'Date': 'ds', 'High': 'y', 'Currency': 'unique_id'}, inplace=True)
...
y_pred = Y_hat_df['TFT-median'].to_numpy().reshape(-1, 1)
...
output_df.to_csv(f'{results_dir}/tft_dez2020_predictions.csv', index=False)
...
pd.DataFrame([metrics]).to_csv(f'{results_dir}/metrics_tft.csv', index=False)


ax.set_title('Previsão com TFT e Dados Reais', fontsize=22)
